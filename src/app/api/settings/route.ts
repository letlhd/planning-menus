...
const SettingsSchema = z.object({
  ...
  defaultFoodMode: z.enum(["VEGETARIAN", "MEAT", "FISH", "FESTIVE", "RECEPTION"]).optional(),
  defaultDinnerFoodMode: z.enum(["VEGETARIAN", "MEAT", "FISH", "FESTIVE", "RECEPTION"]).optional(),
...
const DEFAULT_SETTINGS = {
  ...
  defaultFoodMode: "MEAT" as const,
  defaultDinnerFoodMode: "VEGETARIAN" as const,
  festiveDays: [5, 6, 0],
  noLunchDays: [1, 2, 4, 5],
  maxPrepTime: null,
  dbRatio: 0.7,
